...
class ExamController extends Controller
{
    ...
    public function PDFResult($result_id, $user_id)
    {
        ...
        if ($result) {
            ...
            if ($result->score > 9) {
                $pass = __('в том, что он(она) прошел(а) собеседование и получил(а) <i>«допуск»</i> для подачи документов на платное обучение по группе образовательных программ КазНПУ имени Абая.');
            } else {
